  ...
  return (
    <div>
      ...
      <Container maxWidth="lg">
        <TopIntroduction description={description[0]} lang={locale} i18n={dict['translation']}/>
        <Box sx={{ mt: 6 }}>
          <Typography variant="h4">
            { dict['translation']['general']['portfolio'] }
          </Typography>
          <ImageGrid images={urls} props={{ sx: { backgroundColor: 'black' } }} isModal={false}/>
          <Box mt={2} textAlign={'center'}>
            <Link href='/portfolio'><Button variant="contained">{dict['translation']['general']['see_portfolio']}</Button></Link>
          </Box>
        </Box> 
        ...
        <Box sx={{ mt: 6 }}>
          ...
          <Box mt={2} textAlign={'center'}>
            <Link href='/service'><Button variant="contained">{dict['translation']['general']['view_service']}</Button></Link>
          </Box>
        </Box>
      </Container>
      <Box
