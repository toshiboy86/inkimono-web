export const en = {
  translation: {
    ...
    index: {
      ...
      about_top: "I offer personalized kimono experience:\n kimono styling, combined with an explanation about kimono and a professional photoshoot. I do my best to create a unique kimono outfit for you — an outfit made of traditional, authentic items — and take professional portraits of you. Every outfit is unique, as I don't repeat same outfit combinations.",
    ...
    service: {
      ...
      about_1: "Inspired by the rich world of kimono patterns, fascinating history, colours and tradition, I decided to share my skills and knowledge with others. In November 2018 I created INKIMONO.",
      about_2: "I offer kimono experience with a professional portrait photoshoot on location. I offer personalized styling ― I will choose a full kimono outfit based on your personal style, favorite colours, style, any requests you may have.",
      about_3: "I often add some historical and cultural background of kimono while dressing! I believe that knowing what you wear, where it came from, what’s the story behind it, makes you appreciate it more and get even closer to Japanese culture. With my photoshoots I can also offer hairstyling (done by me) and a makeup option (done by a makeup artist).",
      quality_1: "I use only authentic, often antique and vintage silk kimono and obi.",
      quality_2: "For portrait photoshoots I use Canon 6 EOS Mark II. I edit photos using Adobe Lightroom Photoshop and provide professionaly edited high resolution images.",
